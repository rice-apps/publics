            ...
            <main>
                <div className="hero min-h-[60vh] object-left-top">
                    <div className="hero-content items-stretch flex-col md:flex-row min-w-[70vw]">
                        <img src="https://as2.ftcdn.net/v2/jpg/03/09/55/15/1000_F_309551534_hkPIgAAsyc5EQg0Ny2bUYh8ttkUWc8fA.jpg" className="object-cover min-w-[30%] sm:max-w-[30%] min-h-sm rounded-lg shadow-2xl" />
